...
const popularNews = [
    {
        queryId: '1',
        title: 'TP.HCM: Đề xuất xây dựng thêm 2 cầu vượt tại cửa ngõ sân bay Tân Sơn Nhất',
        source: 'VnExpress',
        time: '2 giờ trước',
    ...
    {
        queryId: '2',
        title: 'Đà Lạt: Cảnh báo sạt lở tại các khu vực đồi dốc sau mưa lớn kéo dài',
        source: 'Tuổi Trẻ',
        time: '5 giờ trước',
    ...
    {
        queryId: '3',
        title: 'Khám phá đỉnh núi Bà Đen: Điểm đến tâm linh không thể bỏ qua tại Tây Ninh',
        source: 'Travel.vn',
        time: '1 ngày trước',
    ...
    return (
        <div className={`${className} ${styles.container}`}>
            ...
            <div className={`${styles.list} ${styles.noScrollbar}`}>
                {loading ? (
                    // Hiển thị 5 khung xương khi đang load
...
function NewsSkeleton() {
    return (
        <div className={styles.newsItem}>
            ...
            <div className={styles.content}>
                <div className={`${styles.skeleton}`} style={{ height: '14px', width: '90%', borderRadius: '4px', marginBottom: '8px' }}></div>
                <div className={`${styles.skeleton}`} style={{ height: '14px', width: '60%', borderRadius: '4px' }}></div>
                <div className={styles.meta} style={{ marginTop: 'auto' }}>
                    <div className={`${styles.skeleton}`} style={{ height: '10px', width: '30%', borderRadius: '4px' }}></div>
                </div>
            </div>
        </div>
    );
